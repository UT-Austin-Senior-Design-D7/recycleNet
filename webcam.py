...
parser.add_argument('--resize_needed', default=False, type=bool)
...
def main(save_dir, resize_needed):
    ...
    '''
    NOTE: REWRITTEN FOR PASSED IN IMAGE
    NOTE: save_dir should be the path to image to predict
    '''
    if resize_needed:
    	img = cv2.imread(save_dir, cv2.COLOR_RGBA2RGB)
    	dim = (512, 384)
...
if __name__ == '__main__':
    ...
    '''
    main(args.save_dir, args.resize_needed)